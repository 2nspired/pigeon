...
The full migration walkthrough lives in [`docs/archive/MIGRATING-TO-PIGEON.md`](https://github.com/2nspired/pigeon/blob/main/docs/archive/MIGRATING-TO-PIGEON.md).
